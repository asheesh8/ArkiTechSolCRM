            ...
            <AnimatePresence mode="wait">
              {view === "choose" && (
                <motion.div
                  ...
                  style={{ background: "#0a0a0e", border: "1px solid rgba(236,233,227,0.18)" }}
                >
                  {/* macOS title bar */}
                  <div className="flex items-center gap-3 border-b px-4 py-3.5" style={{ borderColor: "rgba(236,233,227,0.16)" }}>
                    <div className="flex items-center gap-1.5">
                      <button type="button" aria-label="Close" onClick={onClose} className="group h-3 w-3 rounded-full" style={{ background: "#ff5f57" }}>
                        <X className="h-2 w-2 opacity-0 group-hover:opacity-100 text-black/50 m-auto" />
                      </button>
                      <div className="h-3 w-3 rounded-full" style={{ background: "#febc2e" }} />
                      <div className="h-3 w-3 rounded-full" style={{ background: "#28c840" }} />
                    </div>
                    <span className="mono flex-1 text-center" style={{ color: "rgba(236,233,227,0.56)", fontSize: "0.58rem" }}>
                      Get in touch
                    </span>
                  </div>
                  ...
                  <div className="p-6 flex flex-col gap-3">
                    ...
                    <button
                      ...
                      className="flex items-center gap-4 p-4 text-left transition-colors duration-150 hover:bg-[rgba(236,233,227,0.56)]"
                      style={{ border: "1px solid rgba(236,233,227,0.16)" }}
                    >
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center" style={{ background: "#6c5cf7" }}>
                    ...
                    <button
                      ...
                      style={{ border: "1px solid rgba(236,233,227,0.16)" }}
                    >
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center" style={{ border: "1px solid rgba(236,233,227,0.24)" }}>
                        <Phone className="h-4 w-4 text-[#ece9e3]" />
                      </div>
                      <div>
                ...
                >
                  ...
                  <div className="flex items-center gap-3 border-b px-4 py-3.5" style={{ borderColor: "rgba(255,255,255,0.06)", background: "rgba(255,255,255,0.02)" }}>
                    <div className="flex items-center gap-1.5">
                      ...
                      <button type="button" aria-label="Back to contact options" onClick={() => setView("choose")} className="group h-3 w-3 rounded-full" style={{ background: "#febc2e" }}>
                    ...
                    <button
                      ...
                      className="mono flex items-center gap-1.5 border px-3 py-2 text-[#ece9e3] transition disabled:opacity-50"
              ...
              {view === "call" && (
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-5 p-8 text-center">
                    <div className="flex h-16 w-16 items-center justify-center" style={{ border: "1px solid rgba(236,233,227,0.24)" }}>
