  ...
  return (
    <main className="overflow-x-hidden" style={{ background: "#0c0c18", color: "white" }}>
      ...
      <section className="relative overflow-hidden py-40 text-center px-6" style={{ background: "#0e0e1c" }}>
        <div className="pointer-events-none absolute left-1/2 top-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-25"
        ...
        <div className="relative z-10">
          ...
          <p className="mt-5 text-lg text-white/40">Starting at $197/mo. No agency bloat — just clean, fast, converting websites.</p>
          <button
